  ...
  canActivate() {
    let data = this._auth.loadFromLocalStorage().then(x => {
      ...
      if (!this.jwthelper.isTokenExpired(token)) {
        ...
        chrome.tabs.create({
          url: 'https://beta.boomconcole.com',
          selected: true
        });
        return false;
      }
